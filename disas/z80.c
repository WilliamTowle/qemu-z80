...
static
int prt_e (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char e;
    int target_addr;
...
static
int jr_cc (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
...
static
int prt_nn (struct buffer *buf, disassemble_info * info, const char *txt)
{
    int nn;
    unsigned char *p;
...
static
int prt_rr_nn (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
...
static
int prt_rr (struct buffer *buf, disassemble_info * info, const char *txt)
{
...
static
int prt_n (struct buffer *buf, disassemble_info * info, const char *txt)
{
    int n;
    unsigned char *p;
...
static
int ld_r_n (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
...
static
int prt_r (struct buffer *buf, disassemble_info * info, const char *txt)
{
...
static
int ld_r_r (struct buffer *buf, disassemble_info * info, const char *txt)
{
    info->fprintf_func (info->stream, txt,
                        r_str[(buf->data[buf->n_fetch - 1] >> 3) & 7],
...
static
int arit_r (struct buffer *buf, disassemble_info * info, const char *txt)
{
    info->fprintf_func (info->stream, txt,
...
static
int prt_cc (struct buffer *buf, disassemble_info * info, const char *txt)
{
    info->fprintf_func (info->stream, "%s%s", txt,
...
static
int pop_rr (struct buffer *buf, disassemble_info * info, const char *txt)
{
...
static
int jp_cc_nn (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
...
static
int arit_n (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
...
static
int rst (struct buffer *buf, disassemble_info * info, const char *txt)
{
...
static
int cis (struct buffer *buf, disassemble_info * info, const char *txt ATTRIBUTE_UNUSED)
{
...
static
int pref_ed (struct buffer * buf, disassemble_info * info, 
...
static
int pref_cb (struct buffer * buf, disassemble_info * info,
            const char* txt ATTRIBUTE_UNUSED)
{
    if (fetch_data (buf, info, 1))
    {
...
static
int addvv (struct buffer * buf, disassemble_info * info, const char* txt)
{
...
static
int ld_v_v (struct buffer * buf, disassemble_info * info, const char* txt)
{
    char mytxt[TXTSIZ];
...
static
int prt_d (struct buffer *buf, disassemble_info * info, const char *txt)
{
    int d;
    signed char *p;
...
static
int prt_d_n (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
    int d;
    signed char *p;
...
static
int arit_d (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
    signed char c;
...
static
int ld_r_d (struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
    signed char c;
...
static
int ld_d_r(struct buffer *buf, disassemble_info * info, const char *txt)
{
    char mytxt[TXTSIZ];
    signed char c;
...
static
int pref_xd_cb (struct buffer * buf, disassemble_info * info, const char* txt)
{
    if (fetch_data (buf, info, 2))
    {
        int d;
...
static
int pref_ind (struct buffer * buf, disassemble_info * info, const char* txt)
{
    if (fetch_data (buf, info, 1))
    {
        char mytxt[TXTSIZ];
...
{
//#if 0   /* TODO: some print handlers missing */
    { 0x00, 0xFF, prt, "nop" },

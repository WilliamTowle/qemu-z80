...
static void zaphod_screen_realizefn(DeviceState *dev, Error **errp)
{
    ...
    /* Distinguish screen type by text color:
     * The "simple" screen (green on black) is a Phil Brown style
     * basic console with simple escape codes; the "enhanced" display
     * (orange on black) has CGA-like character attributes and a
     * graphics mode
	 */

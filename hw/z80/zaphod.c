...
#else	/* TODO: conditional screen init */
...
#define DEFINE_ZAPHOD_MACHINE(board_id, desc_str, make_default) \
...
#define DEFINE_ZAPHOD_MACHINE_OPTION(board_id, desc_str) \
        DEFINE_ZAPHOD_MACHINE(board_id, desc_str, false)
#define DEFINE_ZAPHOD_MACHINE_DEFAULT(board_id, desc_str) \
        DEFINE_ZAPHOD_MACHINE(board_id, desc_str, true)
